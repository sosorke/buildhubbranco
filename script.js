const defaultSiteContent = {
  heroTitle: "BuildHub transforma ideias em plataformas digitais de alta performance.",
  heroSubtitle: "Criamos sites, sistemas e interfaces que combinam tecnologia, estrategia e uma experiencia visual memoravel.",
  serviceWeb: "Desenvolvimento Web",
  serviceSystems: "Sistemas",
  serviceLanding: "Landing Pages",
  serviceUx: "UI/UX Design",
  aboutStory: "Fundada por especialistas em produto digital, a BuildHub atua como uma ponte entre a ambicao de marcas modernas e a execucao tecnica necessaria para lancar experiencias confiaveis.",
...
const state = {
  projects: [
    {
      id: 1,
      title: "NovaHaus Studio",
      category: "institucional",
      label: "Site institucional",
      description: "Site premium para escritorio de arquitetura com narrativa visual, captacao de leads e paginas institucionais.",
      stack: "HTML, CSS, JavaScript, SEO tecnico",
      progress: 100
    },
    {
      id: 2,
      ...
      category: "ecommerce",
      label: "E-commerce",
      description: "Loja online com vitrine sofisticada, filtros de produtos, carrinho simulado e fluxo de compra enxuto.",
      stack: "Catalogo, UI de checkout, analytics",
      progress: 92
    },
    {
      id: 3,
      ...
      category: "landing",
      label: "Landing page",
      description: "Landing page para lancamento de produto SaaS com secao de beneficios, prova social e chamada direta.",
      stack: "Copy, animacoes, formularios",
      progress: 86
    },
    {
      id: 4,
      ...
      category: "sistemas",
      label: "Sistema web",
      description: "Dashboard operacional para acompanhamento de tarefas, indicadores e entregas de times internos.",
      stack: "Dashboard, autentificacao simulada, dados locais",
      progress: 74
    },
    {
      id: 5,
      title: "MedCore Digital",
      category: "institucional",
      label: "Site institucional",
      description: "Presenca digital para clinica com foco em confianca, agendamento, conteudo e performance mobile.",
      stack: "Design system, responsivo, acessibilidade",
      progress: 100
    },
    {
      id: 6,
      title: "DropX Campaign",
      category: "landing",
      label: "Landing page",
      description: "Pagina de campanha com visual futurista, blocos de conversao e formulario integrado ao painel local.",
      stack: "Conversao, motion, localStorage",
      progress: 68
    }
  ],
  users: [
...
const storageKeys = {
  ...
  siteContent: "buildhub_site_content"
};
...
function updateActiveNav() {
  const sections = ["home", "quem-somos", "portfolio", "contato", "login"];
...
function renderProjects() {
  selectors.projectGrid.innerHTML = state.projects.map((project) => `
    <article class="project-card reveal" role="button" tabindex="0" data-project-id="${project.id}" data-category="${project.category}">
      ...
      <div class="project-hover">Clique para ver detalhes, tecnologias e andamento.</div>
    </article>
  `).join("");
  initRevealAnimations();
}
...
function openProjectModal(project) {
  selectors.modalContent.innerHTML = `
    ...
    <h2>${project.title}</h2>
    <p>${project.description}</p>
    <p><strong>Tecnologias:</strong> ${project.stack}</p>
    <p><strong>Andamento:</strong> ${project.progress}%</p>
